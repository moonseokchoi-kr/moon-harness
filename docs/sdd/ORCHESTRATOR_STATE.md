...
|----|------|--------|--------|-----------|-------|------|
| T-1 | 1 | sdd-python-engineer | pending | 0 | - | 코어 패키지 + pytest |
| T-2 | 1 | sdd-implementer | pending | 0 | - | SKILL.md SSOT 절차 |
| T-3 | 2 | sdd-implementer | pending | 0 | - | sdd-implementer 단락 주입 (준-protected) |
| T-4 | 3 | sdd-implementer | pending | 0 | - | evals 폴백 시나리오 |
