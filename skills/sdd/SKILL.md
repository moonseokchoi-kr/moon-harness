...
| `sdd-architect` | 2 | opus | 아키텍처 결정, develop 작성 |
...
sdd는 직접 develop을 작성하지 않는다. sdd-architect + api-designer + architect-reviewer 협업.
...
1. 컨텍스트 탐색 → `sdd-architect` 디스패치 (develop 작성)
...
5. sdd-architect → develop 통합 생성 (제약사항 포함) → PHASE2_DEVELOP_INTEGRATED
