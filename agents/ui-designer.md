...
```
Skill(design-md)
→ 저장 경로: docs/spec-design/design/DESIGN.md
```
...
산출물은 `docs/spec-design/design/ui/{YYYY-MM-DD}-{feature}.md`에 저장한다.
...
- **DESIGN.md**: `docs/spec-design/design/DESIGN.md` — 디자인 토큰, 컬러, 타이포그래피 (**Step 3-5에서 생성됨**)
