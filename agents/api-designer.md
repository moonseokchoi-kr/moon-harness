---
name: api-designer
description: "Phase 2-C — spec, IA, UI 명세를 기반으로 API 계약을 정의한다"
model: opus
---
...
산출물은 `docs/spec-design/design/api/{YYYY-MM-DD}-{feature}.md`에 저장한다.
...
**산출물:** `docs/spec-design/design/api/{YYYY-MM-DD}-{feature}.md`
